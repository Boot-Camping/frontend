  ...
  return (
    <>
      <ul className="catgory">
        <li>
          <Link to={{ pathname: "/categorypage", state: { title: "전체" } }}>
            <img
        ...
        <li>
          <Link to={{ pathname: "/categorypage", state: { title: "숲속" } }}>
            <img
              className="catgory-img"
        ...
        <li>
          <Link to={{ pathname: "/categorypage", state: { title: "바다" } }}>
            <img
              className="catgory-img"
        ...
        <li>
          <Link to={{ pathname: "/categorypage", state: { title: "계곡" } }}>
            <img
              className="catgory-img"
        ...
        <li>
          <Link to={{ pathname: "/categorypage", state: { title: "반려견" } }}>
            <img
              className="catgory-img"
        ...
        <li>
          <Link to={{ pathname: "/categorypage", state: { title: "노키즈" } }}>
            <img
              className="catgory-img"
