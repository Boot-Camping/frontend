...
//     console.log("Updated Notice Data:", formData);

//     try {
//       await post(`admin/notice`, formData, customHeaders);
...
const AdminNoticeRegisterPage = () => {
  ...
  const handleSubmit = async () => {
    const noticeRequest = JSON.stringify({
      title: title,
    ...
    const formData = new FormData();
    formData.append("noticeRequest", noticeRequest);
